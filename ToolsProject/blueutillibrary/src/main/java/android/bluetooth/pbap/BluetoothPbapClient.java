...
public class BluetoothPbapClient implements ClientAction<ArrayList<VCardEntry>> {
    ...
    /**
     * Path to local incoming calls history object 手机来电记录
     */
    public static final String ICH_PATH = "telecom/ich.vcf";

    /**
     * Path to local outgoing calls history object 手机去电记录
     */
    public static final String OCH_PATH = "telecom/och.vcf";

    /**
     * Path to local missed calls history object 手机未接电话记录
     */
    public static final String MCH_PATH = "telecom/mch.vcf";

    /**
     * Path to local combined calls history object 所有通话记录
     */
    public static final String CCH_PATH = "telecom/cch.vcf";

    /**
     * Path to local main phone book object 手机联系人
     */
